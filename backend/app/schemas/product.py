...
class ProductBase(BaseModel):
    ...
    family: Optional[Literal["Zeus", "Balcony", "MasPedidos", "Partner", "Servicios"]] = None
    category: Optional[Literal["monthly_fee", "license", "implementation", "hours", "one_time"]] = None
